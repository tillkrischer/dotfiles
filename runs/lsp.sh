...
dotnet tool install --global roslyn-language-server --source https://pkgs.dev.azure.com/azure-public/vside/_packaging/vs-impl/nuget/v3/index.json --version "5.8.0-1.26229.18"
